package br.com.renanmassaroto.projects.a3dtest.second_version;
...
import br.com.renanmassaroto.projects.a3dtest.common.view.SurfaceView;
...
public class SecondTestActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Vertex vertex = new Vertex(
                new Point3D(0, 0, 0, Color.RED),
                new Point3D(1, 0, 0, Color.BLUE)
        );

        vertex.calculatePoints();

        if (vertex.points != null) {
            mSurfaceView.points = vertex.points;
